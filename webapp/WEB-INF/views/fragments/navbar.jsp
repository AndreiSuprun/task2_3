    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
        ...
        <ul class="navbar-nav ml-auto">
            <c:if test="${sessionScope.user eq null}">
                ...
                >
                    <a class="nav-link" href="<c:url value="/app/register"/>">
                        <i class="fa fa-user-plus fa-lg" aria-hidden="true">&nbsp;</i> <fmt:message key="register"/>
                    </a>
                </li>
                <li
            ...
            <c:if test="${not empty sessionScope.user}">
                <c:if test="${!sessionScope.user.isAdmin()}">
                    ...
                    >
                        <a class="nav-link" href="<c:url value="/app/bin"/>">
                            <i class="fa fa-shopping-cart fa-lg" aria-hidden="true">&nbsp;</i>
                            <fmt:message key="bin"/>&nbsp;
                            <span class="badge badge-light">
                                <c:choose>
                                    <c:when test="${not empty sessionScope.subscrptionBin}">
